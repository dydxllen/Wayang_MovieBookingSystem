...
<body>
    ...
    <div>
        <section class="movie-page">
                <div class="details">
                    <img class="movie-poster" src="img/m8.jpg" alt="Call Me by Your Name">
                    <div class="description">
                        <div class="movie-title">
                            <h1>Call Me by Your Name</h1>
                        </div>
                        <ul class="movie-details">
                            <li><i class='bx bxs-calendar' id="icon" ></i> Release Date: 24/11/2017</li>
                            <li>
                                <i class='bx bxs-message-dots' id="icon" ></i> 
                                Spoken Language: ENG</li>
                            <li>
                                <i class='bx bxs-time' id="icon"></i> 
                                Running time: 132 minutes</li>
                            <li>
                                <i class='bx bxs-purchase-tag' id="icon">
                                </i> Genre: Romance/Drama</li>
                        </ul>
                            <p><strong>Ditributor</strong><br> Sony Pictures</p> <br>
                            <p><strong>Cast</strong><br>Armie Hammer, Timothée Chalamet, Michael Stuhlbarg, Amira Casar, Esther Garrel, Victoire Du Bois</p> <br>
                            <p><strong>Synopsis</strong><br>Elio, a teenager, develops feelings for Oliver, his father's temporary assistant. Although their relationship is temporary, Elio realises his sexual orientation and tries to come to terms with it.<br></p>
                            <br>
