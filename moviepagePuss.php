...
<body>
    ...
    <div>
        <section class="movie-page">
                <div class="details">
                    <img class="movie-poster" src="img/m1.png" alt="puss in boots">
                    <div class="description">
                        <div class="movie-title">
                            <h1>Puss In Boots: The Last Wish</h1>
                        </div>
                        <ul class="movie-details">
                            <li><i class='bx bxs-calendar' id="icon" ></i> Release Date: 22/12/2022</li>
                            <li>
                                <i class='bx bxs-message-dots' id="icon" ></i> 
                                Spoken Language: ENG</li>
                            <li>
                                <i class='bx bxs-time' id="icon"></i> 
                                Running time: 103 minutes</li>
                            <li>
                            ...
                            DreamWorks</p> <br>
                            <p><strong>Cast</strong><br>Antonio Banderas, Salma Hayek, Olivia Colman, Harvey Guillen, Samson Kayo, Wagner Moura</p> <br>
                            <p><strong>Synopsis</strong><br>Puss in Boots discovers that his passion for adventure has taken its toll: he has burned through eight of his nine lives. Puss sets out on an epic journey to find the mythical Last Wish and restore his nine lives. <br></p>
                            <br>
