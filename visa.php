    ...
    <section class="promotion" id="promotion">
        ...
        <div class="detail-row">
            ...
            <div class="col-right">
                ...
                <br>
                <ul class="term-list">
                  <li>Only valid from 28 December 2022 - 27 January 2023.</li>
                  <li>Only valid when purchase using VISA cards.</li>
                  <li>Only valid for the purchase of TWO (2) movie tickets within a single transaction.</li>
                  <li>If customer purchases 3 tickets and above, the maximum discount is still capped at RM5.</li>
                  <li>Only valid on Wednesdays.</li>
                  <li>Capped at 800 transactions every Wednesdays only.</li>
                </ul>
