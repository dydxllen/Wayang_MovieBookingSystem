    ...
    <section class="promotion" id="promotion">
        ...
        <div class="detail-row">
            ...
            <div class="col-right">
                ...
                <br>
                <ul class="term-list">
                  <li>This promotion is on a first-come first-served, while stocks last.</li>
                  <li>The sizes and quantity cannot be changed or upgrade.</li>
                  <li>Wayang Cinema reserves the right to cancel this promotion at any stage, if deemed necessary, and / or if any circumstances beyond its control arises.</li>
                  <li>Wayang Cinema reserves the right to amend the mechanics. Terms and conditions at it absolute discretion WITHOUT prior notice.</li>
                  <li>Wayang Cinema decision is final. Complaints will not be entertained.</li>
                  <li>Visuals are for illustration purposes only.</li>
                </ul>
