...
<body>
    ...
    <div>
        <section class="movie-page">
                <div class="details">
                    <img class="movie-poster" src="img/m4.jpg" alt="Avengers">
                    <div class="description">
                        <div class="movie-title">
                            <h1>Avengers: Infinity War</h1>
                        </div>
                        <ul class="movie-details">
                            <li><i class='bx bxs-calendar' id="icon" ></i> Release Date: 27/04/2018</li>
                            <li>
                                <i class='bx bxs-message-dots' id="icon" ></i> 
                                Spoken Language: ENG</li>
                            <li>
                                <i class='bx bxs-time' id="icon"></i> 
                                Running time: 149 minutes</li>
                            <li>
                                <i class='bx bxs-purchase-tag' id="icon">
                                </i> Genre: Action</li>
                        </ul>
                            <p><strong>Ditributor</strong><br> 20th Century Fox</p> <br>
                            <p><strong>Cast</strong><br>Robert Downey Jr., Chris Hemsworth, Mark Ruffalo, Chris Evans, Scarlett Johansson, Benedict Cumberbatch, Don Cheadle, Tom Holland, Chadwick Boseman, Paul Bettany, Elizabeth Olsen, Anthony Mackie, Sebastian Stan, Danai Gurira, Letitia Wright, Dave Bautista, Zoe Saldaña, Josh Brolin, Chris Pratt</p> <br>
                            <p><strong>Synopsis</strong><br>The Avengers must stop Thanos, an intergalactic warlord, from getting his hands on all the infinity stones. However, Thanos is prepared to go to any lengths to carry out his insane plan.<br></p>
                            <br>
